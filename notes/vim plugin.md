...
- [GitHub - airblade/vim-gitgutter: A Vim plugin which shows a git diff in the gutter...](http://github.com/airblade/vim-gitgutter.git)
- [GitHub - fatih/vim-go: Go development plugin for Vim](https://github.com/fatih/vim-go.git)
- [GitHub - elzr/vim-json: A better JSON for Vim: distinct highlighting of keywords vs values, JSON-specific ...](https://github.com/elzr/vim-json.git)
